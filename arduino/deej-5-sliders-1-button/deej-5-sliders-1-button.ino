...
// them: with 5 sliders and 1 button, the line is "s0|s1|s2|s3|s4|b0" and the
// button is channel 5. A pressed button reports 1023, a released one reports 0,
// which is why the existing line format needs no changes at all.
//
...
const int buttonInputs[NUM_BUTTONS] = {2};
